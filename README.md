...
```
---
## ***И немного про `pull request`***

*pull request* — предложение изменения кода в чужом репозитории. 

Алгоритм:
1. Делаем `fork` чужого репозитория (В своём аккаунте на GitHub создать копию чужого репозитория).
2. Клонируем (git clone)копию репозитория на свой локальный компьютер.
3. Создаём новую ветку.
4. Вносим имзенения или создаём что-то новое.
5. Фиуксируем изменения (коммиты).
6. Отправляем изменения на GitHub.
7. На сайте GitHub выполняем `Pull request`.
8. И ждём, возможно наши предложения примут.